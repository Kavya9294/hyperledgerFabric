...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang"  ]; then
 ...
 pushd ../first-network/orderers20/
 echo y | ./byfn.sh down
...
ORDERER_TLS_ROOTCERT_FILE=${CONFIG_ROOT}/crypto/ordererOrganizations/ord1.example.com/orderers/orderer1.ord1.example.com/msp/tlscacerts/tlsca.ord1.example.com-cert.pem
...
--orderer=orderer1.ord1.example.com:7050"
