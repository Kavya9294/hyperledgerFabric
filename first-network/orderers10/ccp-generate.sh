...
echo "$(json_ccp $ORG $P0PORT $P1PORT $P2PORT $CAPORT $PEERPEM $CAPEM)" > connection-org1.json
echo "$(yaml_ccp $ORG $P0PORT $P1PORT $P2PORT $CAPORT $PEERPEM $CAPEM)" > connection-org1.yaml
...
echo "$(json_ccp $ORG $P0PORT $P1PORT $P2PORT $CAPORT $PEERPEM $CAPEM)" > connection-org2.json
echo "$(yaml_ccp $ORG $P0PORT $P1PORT $P2PORT $CAPORT $PEERPEM $CAPEM)" > connection-org2.yaml
